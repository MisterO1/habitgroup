...
// import { Users, Calendar, Plus, LogOut, Trash2 } from 'lucide-react-native';
...
//   const { getUserGroups, user, leaveGroup } = useHabits();
...
//           headerRight: () => (
//             <TouchableOpacity onPress={() => router.push('/controllers/create-group')} style={[styles.createButton, { backgroundColor: colors.primary }]}>
